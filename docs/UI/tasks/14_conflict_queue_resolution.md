...
- Reuse `card.tsx`, `chip.tsx`, and `collapsible.tsx` for conflict presentation. Ensure columns are responsive and readable on narrower screens.
- Use semantic roles and ARIA attributes for side-by-side comparison to aid screen reader users.
